...
5. To fix a tracked bug → use `/fix-issue ENG-NNN` to pull from Linear and fix in a focused session
...
- **Bug workflow:** `/document-bug` → `/fix-issue ENG-NNN` → `/linear-update`
