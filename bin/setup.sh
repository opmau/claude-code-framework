...
echo ""
echo -e "${BLUE}Optional:${NC} For automated TDD enforcement, install tdd-guard:"
echo "  npm install -g tdd-guard"
echo "  Hooks are pre-configured in .claude/settings.local.json"
echo "  See: https://github.com/nizos/tdd-guard"
echo ""
if [ "$DRY_RUN" = true ]; then
